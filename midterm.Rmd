...
Nuestro estimado es: $\hat{\theta}_3 = `r theta.3`$. De tal forma que, con nuestra variable de control, la varianza se reduce en un $`r abs(var.3 / var.1 - 1) * 100`\%$. Finalmente, nuestro estimador $\hat{\theta}_3$ mejora en un $`r abs(var.3 / var.2 - 1) * 100`\%$ respecto a $\hat{\theta}_2$.
...
colours <- c(
  "Monte Carlo crudo" = "#ebcb8b",
  "Variables antitéticas" = "#5e81ac",
  "Variables de control" = "#bf616a"
)
